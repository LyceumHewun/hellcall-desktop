            ...
            <CardContent className="space-y-6">
              <div className="space-y-2">
                ...
                <Slider
                  ...
                  step={0.1}
                  onValueChange={([val]) =>
                    setSettings((s) => ({ ...s, chunk_time: val }))
                  }
                />
              </div>
              <div className="space-y-2">
                <Label>
                  VAD Silence Duration ({settings.vad_silence_duration})
                </Label>
                <Slider
                  ...
                  step={10}
                  onValueChange={([val]) =>
                    setSettings((s) => ({ ...s, vad_silence_duration: val }))
                  }
                />
              </div>
            </CardContent>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setSettings((s) => ({
                      ...s,
                      wait_open_time: Number(e.target.value),
                    }))
                  }
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setSettings((s) => ({
                      ...s,
                      key_release_interval: Number(e.target.value),
                    }))
                  }
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setSettings((s) => ({
                      ...s,
                      diff_key_interval: Number(e.target.value),
                    }))
                  }
                />
              </div>
            ...
            <CardContent className="space-y-6">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setSettings((s) => ({ ...s, hit_word: e.target.value }))
                  }
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setSettings((s) => ({
                      ...s,
                      hit_word_grammar: e.target.value,
                    }))
                  }
                />
              </div>
